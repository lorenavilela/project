...
Step 6-Create an independent tidy data set with the average of each feature - extracted according to step 3 - by activity and subject.
...
Step 6.3- Adjust the column names in dt_result.<br>
See dt_result sample:<br>
```{r}
tidy_data_sample <- read.table("../project/tidy_data_head5.txt", header = TRUE)
print(tidy_data_sample)
```
